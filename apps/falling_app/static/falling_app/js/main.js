...
function startGame() {
    ...
    myGamePiece = new component(obj_w, obj_h, "static/falling_app/img/ironMan.png", 230, 170, "image");
...
function updateGameArea() {
    ...
    if(myGameArea.frameNo == counter){
        ...
        myGameArea.interval = setInterval(updateGameArea, screenSpeed);
        myGamePiece.image.src = "static/falling_app/img/ironMan.png"
        chuteOpen = false;
...
document.onkeydown = function(e){
    ...
    if(e.keyCode == 37){
        if(myGamePiece.x > 0){
            if(chuteOpen == false){
                myGamePiece.image.src = "static/falling_app/img/ironman2.png";
            }
            else {
                myGamePiece.image.src = "static/falling_app/img/ironman5.png"
            }
            if (chuteOpen == true){
    ...
    if(e.keyCode == 39){
        if(myGamePiece.x < 450){
            if(chuteOpen == false){
                myGamePiece.image.src = "static/falling_app/img/ironman3.png"
            }
            else {
                myGamePiece.image.src = "static/falling_app/img/ironman5.png"
            }
